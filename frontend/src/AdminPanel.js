...
export default function AdminPanel() {
  ...
  async function importPdfs(e) {
    ...
    try {
      const r = await fetch(`${API}/admin/import-pdf`, { method: "POST", headers: { Authorization: `Bearer ${token}` }, body: form });
      const data = await r.json();
